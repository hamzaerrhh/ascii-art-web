          ...
          <SubCard title="Color Shadow">
            <Grid container spacing={gridSpacing}>
              <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
                <CustomShadowBox
                  color="primary.main"
                  shadow={theme.vars.customShadows.primary}
                  label="primary"
                />
              </Grid>
              <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
                <CustomShadowBox
                  color="orange.main"
                  shadow={theme.vars.customShadows.orange}
                  label="orange"
                />
              </Grid>
              <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
                <CustomShadowBox
                  color="success.main"
                  shadow={theme.vars.customShadows.success}
                  label="success"
                />
              </Grid>
              <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
                <CustomShadowBox
                  color="warning.main"
                  shadow={theme.vars.customShadows.warning}
                  label="warning"
                />
              </Grid>
              <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }}>
                <CustomShadowBox
                  color="error.main"
                  shadow={theme.vars.customShadows.error}
                  label="error"
                />
              </Grid>
            </Grid>
